...
import models.lstm_cpu as lstm_models
if opt.model_dir != '':
...
def prep_data(files, filedir):
    ...
    if filedir == 'train':
        regex = re.compile("^/data/cr1/cbarth/phd/SVG/training_data/(\d*)") #nobackup/sccsb/radar/train/(\d*)")
        yyyy = '2018'
...
for epoch in range(opt.niter):
    ...
    print('frame_predictor.train')
    frame_predictor.train()
    print('posterior.train')
    posterior.train()
    print('prior.train')
    prior.train()
    print('encoder.train')
