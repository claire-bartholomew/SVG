...
model_path = '/scratch/cbarth/phd/model530043.pth' #131219.pth' #582525.pth' #need to change line 79 too
...
def main(startdate, enddate):
    ...
    mod = 'model530043' #need to change line 33 too
...
if __name__ == "__main__":
    startdate = datetime.strptime('201905300000', '%Y%m%d%H%M')
    enddate = datetime.strptime('201910010200', '%Y%m%d%H%M')
